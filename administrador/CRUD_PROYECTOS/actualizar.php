...
if (empty ($_POST['nombre']) || empty($_POST['descripcion'])){
    ...
    $query="UPDATE `proyectos` SET `nombre_proyecto`='$nombre',`descripcion`='$descripcion',`imagen`='$imagen',`id_carrera`='$id_carrera' WHERE `id_proyectos`='$id'";
    $resultado = $conexion->query($query);
    if($resultado){
        echo "<script>alert('Se ha actualizado el proyecto correctamente')</script>";
    }else{
...
<form method="POST" enctype="multipart/form-data">
    ...
    <p>
    <label for="id" class="colocar_nombre">ID del proyecto 
    <span class="obligatorio">*</span></label>
    <input type="number" name="id" required="obligatorio"  placeholder="Ingresa el id del proyecto"><br><br>
    </p>
    <p>
...
<nav class="navegacion-principall">
        ...
        <button type="submit" name="Editar" ><p><a  href="proyectos.php" >Agregar </a></p></button>
