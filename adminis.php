  ...
  <!-- formulario de contacto en html y css -->  
	...
	<div class="contact_form">
		...
		<div class="formulario">			
                ...
                <form action="administrador/logica/loguear.php" method="post">				
...
<p>
    <label for="nombre" class="colocar_nombre">Nombre de usuario:
        ...
        <input type="text" name="unombre"  required="obligatorio"  required pattern="[A-Za-z]+" placeholder="Usuario">
</p>

<p>
    <label for="nombre" class="colocar_apellidos">Contraseña: 
        
    </label>
        <input type="password" name="uclave"  required="obligatorio"   placeholder="Contraseña">
</p>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 footer-bottom-right">
                    <p>Roxana Estrada, Dulce Reyes y Leslie 5M TI <a href="http://www.utvm.edu.mx/" target="_blank">Utvm</a>  </p>
                </div>
            </div>
        </div>
    </section>
