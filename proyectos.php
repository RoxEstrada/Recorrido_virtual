<?php
include "administrador/CRUD_PROYECTOS/conexion.php";
?>
...
<header class="header">
        <div class="contenedor contenido-header">
            ...
            <nav class="navegacion-principal">
                <a href="index.html">Volver a sección aspirantes</a>
            </nav>
    ...
    <center>
    <h2>Proyectos realizados en la UAT</h2></center><br>
    <div class="containerr">
        <table class="table">
            ...
            <tbody>
            <?php
$query = mysqli_query($conexion, "SELECT proyectos.id_proyectos, proyectos.nombre_proyecto, proyectos.descripcion, proyectos.imagen, carrera.Nombre_carrera AS nombre_carrera FROM proyectos INNER JOIN carrera ON carrera.id_carrera = proyectos.id_carrera ");
...
if ($result>0){
    while ($data = mysqli_fetch_array($query)){
        ...
        <tr>
            ...
            <td><img height="240px" src="data:image/jpg;base64, <?php echo base64_encode($data['imagen']) ?>"></td>
    </tr>
    <?php
    }
}
